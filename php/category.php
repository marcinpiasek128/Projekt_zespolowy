...
if(isset($_POST['send'])) {
    if($_POST['gatunek'] == '0') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
    if($_POST['gatunek'] == '1') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie WHERE movies.Types='Horror'  GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
    ...
    if($_POST['gatunek'] == '2') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie WHERE movies.Types='Komedia'  GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
    ...
    if($_POST['gatunek'] == '3') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie WHERE movies.Types='Dramat'  GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
    ...
    if($_POST['gatunek'] == '4') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie WHERE movies.Types='Sci-Fi'  GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
    ...
    if($_POST['gatunek'] == '5') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie WHERE movies.Types='Fantasy'  GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
    ...
    if($_POST['gatunek'] == '6') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie WHERE movies.Types='Anime'  GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
    ...
    if($_POST['gatunek'] == '7') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie WHERE movies.Types='Akcja'  GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
    ...
    if($_POST['gatunek'] == '8') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie WHERE movies.Types='Przygodowy'  GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
    ...
    if($_POST['gatunek'] == '9') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie WHERE movies.Types='Wojenny'  GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
    ...
    if($_POST['gatunek'] == '10') {
        ...
        if($_POST['sortuj_po'] == '3') {
            $query = "SELECT movies.*, COUNT(rating.ID_Movie) as numberRatings FROM movies LEFT JOIN rating on movies.ID_Movie = rating.ID_Movie WHERE movies.Types='Historyczny'  GROUP BY movies.ID_Movie ORDER BY `numberRatings` DESC";
            $result = $conn->query($query);
            include("getmovie.php");
        }
    }
